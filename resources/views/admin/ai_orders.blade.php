                            ...
                            <tbody>
                                @foreach ($aiOrders as $aiOrder)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.ai_orders.edit', $aiOrder->id) }}" class="btn btn-primary">Edit</a>
                                            <form action="{{ route('admin.ai_orders.destroy', $aiOrder->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
