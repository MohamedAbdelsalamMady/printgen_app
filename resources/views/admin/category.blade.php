                    ...
                    <div class="category-section">
                        ...
                        <div class="body-category">
                            <form action="{{ url('/add_category') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label for="inputText3" class="col-form-label" style="font-size: 17px;">Category Name</label>
                                        <input id="inputText3" type="text" class="form-control" name="category_name"
                                            placeholder="Write Category Name" style="height: 60%; font-size: 20px;">
                                    </div>
                                    <div class="col">
                                ...
                                <tbody>
                                    <tr>
                                        @foreach ($data as $data)
                                            ...
                                            <td>
                                                <a class="btn btn-danger" href="{{ url('/delete_category',$data->id) }}"><svg
