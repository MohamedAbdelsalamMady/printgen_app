...
<head>
    ...
    <!-- Bootstrap CSS -->
    @include('admin.css');
    <title>High Tech Egypt - Update Product</title>
</head>
                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{ url('admin.home') }}" class="breadcrumb-link">Dashboard</a></li>
                        ...
                        <div class="product-content">
                            <form action="{{ url('/add_employee') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputText3" type="text" class="form-control" name="employee_name"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputText3" type="number" class="form-control" name="salary"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputText3" type="number" class="form-control" name="years_of_exp"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputText3" type="date" class="form-control" name="date_of_birth"
